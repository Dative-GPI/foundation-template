...
namespace Foundation.Extension.Context.Repositories
{
    public class OrganisationTypeDispositionRepository : IOrganisationTypeDispositionRepository
    {
        ...
        public async Task<IEnumerable<OrganisationTypeDisposition>> GetMany(ColumnOrganisationTypesFilter filter)
        {
            ...
            return result.Select(r => new OrganisationTypeDisposition()
            {
                Id = r.Id,
                ColumnId = r.ColumnId,
                Disabled = r.Disabled,
