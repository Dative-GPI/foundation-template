...
{
    public class UpsertOrganisationTypePermissionsCommandHandler : IMiddleware<UpsertOrganisationTypePermissionsCommand>
    {
        private IOrganisationTypePermissionRepository _organisationTypePermissionRepository;

        public UpsertOrganisationTypePermissionsCommandHandler(IOrganisationTypePermissionRepository organisationTypePermissionRepository)
        {
            _organisationTypePermissionRepository = organisationTypePermissionRepository;
        }

        public async Task HandleAsync(UpsertOrganisationTypePermissionsCommand request, Func<Task> next, CancellationToken cancellationToken)
        {
