...
import { usePermissionApplications, useRolePermissionApplications, useUpdateRolePermissionApplications } from "../composables";
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const { getAll, permissionApplications, categories } = usePermissionApplications();
